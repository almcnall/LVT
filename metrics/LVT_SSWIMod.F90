    ...
    if(LVT_metrics%sswi%selectOpt.eq.1.or.&
       ...
       if(model%short_name.eq."RootMoist") then 
          ...
          LVT_sswi_struc%nsize_total = &
               LVT_sswi_struc%nasc*LVT_sswi_struc%nsize_season
...
!EOP
    ...
    if(stats%selectOpt.eq.1.and.&
         (model%short_name.eq."RootMoist").and.&
...
!          print*, t, tind, LVT_sswi_struc%model_rzsm_final(t,tindex_f), &
!               LVT_sswi_struc%model_mu(t,tind), &
!               LVT_sswi_struc%model_sigma(t,tind), &
!               LVT_sswi_struc%model_sswi(t)
...
!                do l=1,LVT_sswi_struc%nsize_total
!                   call LVT_writevar_restart(ftn,&
!                        LVT_sswi_struc%model_rzsm_final(:,l))
!                enddo
                do l=1,LVT_sswi_struc%nasc
                   call LVT_writevar_restart(ftn,&
...
!                   do l=1,LVT_sswi_struc%nsize_total
!                      call LVT_writevar_restart(ftn,&
!                           LVT_sswi_struc%obs_rzsm_final(:,l))
!                   enddo
                   do l=1,LVT_sswi_struc%nasc
                      call LVT_writevar_restart(ftn,&
