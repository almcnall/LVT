...
!EOP
    ...
    integer,      allocatable :: ds1_selectNlevs(:),ds1_vlevels(:),ds1_timeAvgOpt(:)
    character*20, allocatable :: ds2_name(:), ds2_unit(:), ds2_dir(:)
    integer,      allocatable :: ds2_selectNlevs(:),ds2_vlevels(:),ds2_timeAvgOpt(:)
...
!--------------------------------------------------------------------------
    ...
    allocate(ds1_selectNlevs(file_lines))
    ...
    allocate(ds2_selectNlevs(file_lines))
    ...
    do i=1,file_lines
       ...
       call ESMF_ConfigGetAttribute(LVT_config, ds1_selectNlevs(i),rc=rc)
       ...
       call ESMF_ConfigGetAttribute(LVT_config, ds2_selectNlevs(i),rc=rc)
       ...
       call register_dataEntry(LVT_MOC_COUNT, nsize,&
            ...
            ds1_name(i), ds1_selectNlevs(i), ds1_unit(i),&
            ds1_dir(i), ds1_timeAvgOpt(i), ds1_vlevels(i),&
            ds2_name(i), ds2_selectNlevs(i), ds2_unit(i), &
            ds2_dir(i), ds2_timeAvgOpt(i), ds2_vlevels(i))

    enddo

    deallocate(ds1_name)
    deallocate(ds1_selectNlevs)
    deallocate(ds1_unit)
    deallocate(ds1_dir)
...
! !INTERFACE: 
 subroutine register_dataEntry(var_count, nsize, &
       ...
       ds1_name, ds1_selectNlevs, ds1_unit, &
       ds1_dir, ds1_timeAvgOpt, ds1_vlevels,&
       ds2_name, ds2_selectNlevs, ds2_unit, &
...
!    
   ...
   integer                          :: ds1_selectNlevs, ds2_selectNlevs
...
!EOP
   ...
   if(ds1_selectNlevs.ne.0) then 
      ...
      ds1dataEntry%selectNlevs   = ds1_selectNlevs
   ...
   if(ds2_selectNlevs.ge.1) then 
      ...
      ds2dataEntry%selectNlevs   = ds2_selectNlevs
...
!stats data structures
   ...
   if(ds1_selectNlevs.ge.1.or.ds2_selectNlevs.ge.1) then 
      allocate(statsEntry)
...
!EOP
    ...
    if(dataEntry%selectNlevs.gt.0) then 
...
!first check if the direction types are consistent
       ...
       if(dataEntry%selectNlevs.gt.0.and.log_var) then 
          do r=1,LVT_rc%lnr
             do c=1,LVT_rc%lnc
