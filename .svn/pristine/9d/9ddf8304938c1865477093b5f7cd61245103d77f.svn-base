                   ...
                   do t=1,LVT_rc%ngrid
                      if(model%count(t,k).ne.0) then 
                         ...
                         stats%hn%value_model_total(t,k,l) = &
                              stats%hn%value_model_total(t,k,l) + model%value(t,k)
                      ...
                      if(obs%count(t,k).ne.0) then 
                         stats%hn%value_obs_total(t,k,l) = &
                              stats%hn%value_obs_total(t,k,l) + obs%value(t,k)
                   ...
                   if(obs%count(t,k).ne.0.and. &
                      ...
                      do t1=1,LVT_rc%ngrid
                         if(obs%count(t1,k).ne.0) then
                            dist = sqrt((model%value(t,k)-obs%value(t1,k))**2)
