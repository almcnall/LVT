...
//
// !INTERFACE:
void FTN(registermetricinit)(int *i,void (*func)(void*, void*, void*, void*))
//  
// !DESCRIPTION: 
...
//
// !INTERFACE:
void FTN(initmetric)(int *i, void *model, void *obs, void *stats, void *metric)
// !DESCRIPTION: 
...
{ 
  ...
  metric_ini[*i].func(model,obs,stats,metric); 
}
